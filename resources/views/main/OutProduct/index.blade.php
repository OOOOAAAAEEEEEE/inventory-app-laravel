...
<div class="row my-3">
    ...
    <div class="col-2">
        <div class="btn-group" role="group" aria-label="Basic outlined example">
            <a href="/outproduct" class="btn btn-outline-primary"> <i class="bi bi-arrow-clockwise"></i> </i> Refresh </a>
            <a href="/outproduct/export" class="btn btn-outline-success"> <i class="bi bi-file-earmark-excel"></i> Export </a>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                {{-- Delete Method --}}
                <form class="d-inline" action="/outproduct/{{ $product->id }}" method="POST">
                @csrf
                @method('delete')
